...
@ComponentScans(value = {@ComponentScan("com.bluesoft.application.blueapp.dao"), 
						@ComponentScan("com.bluesoft.application.blueapp.service")})
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setAnnotatedClasses(Contract.class, SystemModel.class, SystemNameToSystemConverter.class);
		return factoryBean;
	}
